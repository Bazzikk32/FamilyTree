...
//        System.out.println(familyTree);
    ...
    static FamilyTree testTree(){
        ...
        Human Sasha = new Human("Sasha", Gender.Female, LocalDate.of(1965,05,02));
        Human Alex = new Human("Alex",Gender.Male, LocalDate.of(1965,05,02));
        familyTree.add(Sasha);
        familyTree.add(Alex);
        Human Dima = new Human("Dmitriy", Gender.Female, LocalDate.of(1965,05,02));
